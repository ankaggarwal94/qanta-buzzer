...
def build_likelihood(config: dict, mc_questions: list) -> TfIdfLikelihood | SBERTLikelihood | T5Likelihood:
    ...
    if model_name.startswith("t5"):
        # Support "t5-small", "t5-base", "t5-large" directly as model names
