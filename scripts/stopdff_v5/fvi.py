...
def run_fvi(
    ...
    *,
    ...
    for k in range(1, max_iterations + 1):
        ...
        # A fixed point necessarily repeats its signature while accumulating the
        # two required convergence checks. Only a repeated state with a material
        # update is evidence of a genuine cycle.
        if sig in seen_states and max_delta > tolerance:
            return FVIResult(
